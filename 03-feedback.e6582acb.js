...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("form.feedback-form"),a=e=>{const{elements:{email:t,message:r}}=e.currentTarget;localStorage.setItem("feedback-form-state",JSON.stringify({[t.name]:t.value,[r.name]:r.value}))};r.addEventListener("input",(0,e.default)(a,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.e6582acb.js.map